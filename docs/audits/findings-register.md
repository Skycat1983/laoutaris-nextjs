...
| F-111 | A-022 | High | Partially mitigated | Public archive, blog, search, shop, detail, and dynamic metadata routes are intentionally dynamic and do not yet use ISR, cached non-`fetch` data functions, cache tags, or `generateStaticParams()`. | T-232 defined the accepted public freshness matrix before runtime cache changes. T-233 then implemented the first proof for biography: cached non-`fetch` service wrappers for article detail/navigation with a 10-minute stale window, `/biography` route-level `revalidate`, dynamic `/biography/[slug]`, no `generateStaticParams()`, and global `MainNavLoader` intentionally left on the direct service to avoid cache propagation into unrelated static shells. T-237 compared the remaining F-111/F-115 options and selected T-238 as the next route-family cache proof. T-238 completed `/collections` default redirect ISR plus cached route-local collection navigation reads while keeping collection detail routes dynamic and root header navigation direct. T-239 completed explicit `/sitemap.xml` one-hour ISR ownership in `src/app/sitemap.ts` without changing sitemap content. T-240 scoped the blog primary-data cache split, T-241 completed cached primary blog detail reads, T-242 completed cached default grouped blog list reads, T-243 selected query normalization/bounds as the prerequisite before sorted blog list caching, T-244 completed that query-hygiene prerequisite, T-245 completed the sorted first-page cache proof, T-246 selected bounded sorted pages 2-5 for less comment-sensitive modes, and T-247 completed that runtime proof. T-248 then compared `/artwork`, `/search`, shop routes, product detail, and F-115 provider work, selecting T-249 as the next narrow runtime proof for only the default `/artwork` browse list; T-249 completed that proof. T-250 scoped the next cache-efficiency wave and selected T-251 for fixed unfiltered `mostRecent` `/artwork` pages 2-5. Comments, `popular` pages beyond page 1, sorted page 6-plus, blog routes, public blog APIs, filtered artwork variants, artwork detail, public artwork APIs, search, shop routes, route-level ISR beyond accepted defaults, and cache tags remain dynamic/deferred. | [A-022 result](results/A-022-nextjs-feature-utilization.md), [production risks](../risks/production-readiness.md), [rendering architecture](../architecture/rendering-and-data-fetching.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [T-232](../tasks/T-232-define-public-cache-freshness-policy.md), [T-233](../tasks/T-233-pilot-biography-cache-proof.md), [T-237](../tasks/T-237-scope-next-nextjs-efficiency-wave.md), [T-238](../tasks/T-238-pilot-collections-redirect-cache-proof.md), [T-239](../tasks/T-239-codify-sitemap-isr-freshness.md), [T-240](../tasks/T-240-scope-blog-primary-data-cache-split.md), [T-241](../tasks/T-241-pilot-blog-primary-detail-cache-proof.md), [T-242](../tasks/T-242-pilot-default-blog-list-cache-proof.md), [T-243](../tasks/T-243-scope-sorted-blog-list-cache-and-query-hygiene.md), [T-244](../tasks/T-244-normalize-public-blog-list-query-parsing-and-bounds.md), [T-245](../tasks/T-245-pilot-sorted-blog-first-page-cache-proof.md), [T-246](../tasks/T-246-scope-bounded-sorted-blog-page-cache-expansion.md), [T-247](../tasks/T-247-pilot-bounded-sorted-blog-page-cache-proof.md), [T-248](../tasks/T-248-scope-next-public-cache-target.md), [T-249](../tasks/T-249-pilot-default-artwork-browse-cache-proof.md), [T-250](../tasks/T-250-scope-next-cache-efficiency-wave.md), [T-251](../tasks/T-251-pilot-bounded-artwork-browse-cache-expansion.md) | T-250 completed 2026-05-24; T-251 planned |
