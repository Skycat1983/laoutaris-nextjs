...
| F-105 | A-005 | High | Partially mitigated | Public detail routes need a consistent not-found/error contract. | A-005 found no route-local public detail `not-found.tsx` files and inconsistent primary-content failure behavior: malformed standalone artwork IDs call `notFound()`, missing artwork/article loaders throw generic errors, collection-scoped artwork can return `null`, and product detail calls `notFound()` for missing Shopify products. T-199 defined the route-family contract, and T-200 completed the standalone and collection-scoped artwork runtime slice. Biography/project article, blog, and Shopify route-local UI follow-ups remain. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [production risks](../risks/production-readiness.md), [T-199](../tasks/T-199-define-public-detail-not-found-contract.md), [T-200](../tasks/T-200-implement-artwork-detail-not-found-contract.md), [T-201](../tasks/T-201-implement-article-blog-detail-not-found-contract.md) | T-200 completed 2026-05-22; T-201 prepared 2026-05-22 |
| F-106 | A-005 | Medium | Converted | Home section loaders silently drop sections on failures or empty data. | A-005 found `Home` renders Suspense skeletons for major sections, but biography, collections, and blog section loaders catch non-Next failures and return `null`, causing skeletons to disappear without a user-facing empty or unavailable state. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md), [production risks](../risks/production-readiness.md) | Reconciled 2026-05-22 |
| F-107 | A-005 | Medium | Converted | Client browse, filter, and infinite-scroll fetch failures need visible user states. | A-005 found artwork filtering/load-more, shop product follow-up fetches, and blog continuous loading failures can be swallowed or left undisplayed, preserving stale data without a visible retry/error state. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [data/API workstream](../workstreams/data-models-and-api.md), [testing workstream](../workstreams/testing-and-quality.md), [production risks](../risks/production-readiness.md) | Reconciled 2026-05-22 |
| F-108 | A-005 | Medium | Converted | Mixed component barrels remain in server callers despite the current client graph guard passing. | A-005 confirmed the recursive client import graph guard passes for current client entries, but server routes/loaders still value-import broad mixed barrels such as `@/components/sections`, `@/components/views`, and loader barrels that can become risky if those callers later become client entries. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [production risks](../risks/production-readiness.md) | Reconciled 2026-05-22 |
| F-109 | A-005 | Medium | Converted | Account subnav is preserved by loader/tests but not mounted in the account layout. | A-005 found `AccountSubnavLoader` and tests still preserve account links and disabled states, but `src/app/account/layout.tsx` imports the loader and comments out the Suspense block that would render it. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [auth workstream](../workstreams/auth-admin-and-permissions.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-22 |
| F-110 | A-005 | Low | Converted | Route loading states need a documented public-route fallback pattern. | A-005 found only root and admin-feed App Router loading files, route-specific public Suspense fallbacks with mixed patterns, an inline `Loading...` fallback on `/project/aims`, and JSON-LD Suspense boundaries with `fallback={null}`. | [A-005 result](results/A-005-frontend-routes-components.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-22 |
...
T-201 was prepared for biography article and blog detail routes.
