...
| F-049 | A-002, A-017 | Medium | Partially mitigated | Public list and search route semantics are under-specified. | T-021 made public search honor the fetcher's `type` parameter while preserving the existing success envelope. A-017 confirmed `/search` still lacks a visible no-results state and exposes `page`/`limit` parsing without response metadata or UI pagination; broader public list empty-state semantics remain under-specified. | [A-002 result](results/A-002-api-contracts.md), [A-017 result](results/A-017-search-navigation-discovery.md), [data/API workstream](../workstreams/data-models-and-api.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md), [T-021](../tasks/T-021-public-search-query-service.md) | T-021 2026-05-14; A-017 reconciled 2026-05-19 |
...
| F-070 | A-009 | Medium | Partially mitigated | Blog and collection images are arbitrary URLs rather than Cloudinary-owned asset references or allowed-host validated assets. | A-009 found blog and collection forms accept free-text `imageUrl` values and schemas validate only URL shape/length, while Next image optimization allows only configured Cloudinary, Flaticon, and Shopify CDN hosts. T-101 documented the interim decision table. T-135 added shared runtime validation so admin article, blog, and collection image URL writes accept only the configured Cloudinary delivery path or documented Flaticon/Shopify CDN external hosts before persistence. Existing data review/migration remains open. | [A-009 result](results/A-009-cloudinary-assets.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [data/API workstream](../workstreams/data-models-and-api.md), [Cloudinary runbook](../runbooks/cloudinary.md), [T-101](../tasks/T-101-define-cloudinary-asset-lifecycle-policy.md), [T-135](../tasks/T-135-harden-content-image-url-validation.md) | T-135 completed 2026-05-19 |
...
| F-072 | A-020 | High | Converted | Public privacy, cookie, terms, and commerce policy pages are missing for active data collection and commerce surfaces. | A-020 found no public policy/static pages and no footer/project-nav policy links, while enquiry, subscription, registration/OAuth, comments, saved lists, and admin records collect personal data. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [production risks](../risks/production-readiness.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [frontend workstream](../workstreams/frontend-routes-and-components.md) | Reconciled 2026-05-18 |
| F-073 | A-020 | High | Converted | Newsletter subscription lacks consent/source metadata and unsubscribe workflow. | A-020 found the newsletter flow submits and persists email only; the subscriber model has `unsubscribed` but no consent text version, source metadata, unsubscribe token, endpoint, or UI. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [production risks](../risks/production-readiness.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [data/API workstream](../workstreams/data-models-and-api.md), [frontend workstream](../workstreams/frontend-routes-and-components.md) | Reconciled 2026-05-18 |
| F-074 | A-020 | High | Converted | Account signup and OAuth data collection lacks terms/privacy acknowledgement and self-service privacy actions. | A-020 found `UserModel` stores account, role, comment, watchlist, and favourite data; credentials signup collects email/password/username with no terms/privacy acknowledgement; OAuth profile persistence exists; and the visible delete-account button is inert while deletion is admin-only. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [production risks](../risks/production-readiness.md), [auth workstream](../workstreams/auth-admin-and-permissions.md), [deployment workstream](../workstreams/deployment-security-and-observability.md) | Reconciled 2026-05-18 |
| F-075 | A-020 | Medium | Converted | Public comments need posting notice, moderation/reporting policy, and deletion/retention expectations. | A-020 found comment forms and public displays expose user-generated text and usernames without a posting notice, moderation/reporting workflow, or documented retention/deletion policy. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [auth workstream](../workstreams/auth-admin-and-permissions.md), [data/API workstream](../workstreams/data-models-and-api.md) | Reconciled 2026-05-18 |
| F-076 | A-020 | Medium | Partially mitigated | Contact and product enquiry flows collect personal data without notice and previously dropped product context before persistence. | T-100 now preserves normalized Shopify product handles from `/project/contact?product=...` through contact form defaults and public enquiry persistence, and rejects invalid product context. Visible privacy/retention notice and approved contact-data handling remain open under R-018. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [Shopify workstream](../workstreams/shopify-commerce.md), [data/API workstream](../workstreams/data-models-and-api.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-100](../tasks/T-100-preserve-product-context-in-enquiries.md) | T-100 completed 2026-05-18 |
| F-077 | A-020 | Medium | Converted | Cookie/session and third-party processing disclosures are incomplete. | A-020 found no analytics/browser-storage SDK evidence, but NextAuth session cookies, OAuth providers, YouTube embeds, Cloudinary media delivery/upload, and Shopify product lookups are active third-party/session surfaces without public disclosure. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [production risks](../risks/production-readiness.md) | Reconciled 2026-05-18 |
| F-078 | A-020 | Medium | Converted | Commerce assurance copy is ahead of implemented checkout/cart and public sale policies. | A-020 found product detail remains an enquiry handoff and cart/orders are disabled, while security banners advertise secure payment, buyer protection, money-back guarantee, and insured/global delivery without matching public policy pages or checkout implementation. | [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [Shopify workstream](../workstreams/shopify-commerce.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [deployment workstream](../workstreams/deployment-security-and-observability.md) | Reconciled 2026-05-18 |
...
| F-092 | A-011 | High | Converted | Destructive admin hard deletes need operator-visible cascade previews, backup gates, and audit evidence. | A-011 found blog, user, comment, and artwork delete routes perform hard deletes or relationship cleanup, but the shared confirmation UI is generic and operators do not see related-record counts, backup evidence requirements, or redacted audit-event expectations before deletion. | [A-011 result](results/A-011-admin-content-operations.md), [production risks](../risks/production-readiness.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [data/API workstream](../workstreams/data-models-and-api.md) | Reconciled 2026-05-19 |
...
| F-094 | A-011 | Medium | Converted | Admin create/update forms hide route validation failures and collection create bypasses its success callback. | A-011 found strict admin routes now return structured validation errors, but dashboard forms often catch and return without surfacing API field/form errors; `CreateCollectionForm` accepts `onSuccess` but does not call it after successful persistence. | [A-011 result](results/A-011-admin-content-operations.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-095 | A-011 | Medium | Converted | Admin archive maintenance relies on manual ObjectId copy/paste and shallow unpaginated read lists. | A-011 found update/delete workflows begin with an ObjectId-only `DocumentReader`, while read tabs request fixed first-page results with no pagination controls or direct path from list/feed items into update/delete operations. | [A-011 result](results/A-011-admin-content-operations.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [frontend workstream](../workstreams/frontend-routes-and-components.md) | Reconciled 2026-05-19 |
| F-096 | A-011, A-018 | Medium | Converted | Blog pinned/tag taxonomy is route-supported but not manageable in visible admin workflows, and blog read filters are stale. | A-011 found persisted and route-supported `pinned` and `tags` fields are omitted from visible blog create/update workflows. A-018 added that `BLOG_TAGS` is canonical server-side and the admin blog read filter hard-codes stale year options instead of deriving current/data-backed values. | [A-011 result](results/A-011-admin-content-operations.md), [A-018 result](results/A-018-translations-content-taxonomy.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-097 | A-011 | Medium | Converted | Admin content CRUD and archive maintenance lack a dedicated operator runbook. | A-011 found no runbook that describes create, update, delete, dependency checks, Shopify link verification, Cloudinary expectations, backup/export preconditions, delete cascade behavior, failure recovery, or post-change smoke checks for admin-managed content. | [A-011 result](results/A-011-admin-content-operations.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [auth runbook](../runbooks/auth.md), [database runbook](../runbooks/database.md), [Cloudinary runbook](../runbooks/cloudinary.md) | Reconciled 2026-05-19 |
| F-098 | A-017 | High | Converted | Global public search excludes artworks and shop products from a site-wide discovery entry point. | A-017 found the search schema and service only support articles, blogs, and collections; artworks and Shopify products are core archive/commerce discovery surfaces but are not searchable from `/search`. | [A-017 result](results/A-017-search-navigation-discovery.md), [production risks](../risks/production-readiness.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [data/API workstream](../workstreams/data-models-and-api.md), [Shopify workstream](../workstreams/shopify-commerce.md), [T-143](../tasks/T-143-decide-public-search-scope.md) | Reconciled 2026-05-19 |
| F-099 | A-017 | Medium | Converted | The `/artwork` page parses browse query parameters differently from the validated public artwork API. | A-017 found the server-rendered `/artwork` page directly casts search params and defaults sort to `colorProximity`, while the API uses `parseArtworkListQuery` and the shared schema defaults to `mostRecent`. | [A-017 result](results/A-017-search-navigation-discovery.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [data/API workstream](../workstreams/data-models-and-api.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-100 | A-017 | Medium | Converted | Blog sorted discovery pages do not preserve sort through follow-up loading or pagination UI. | A-017 found `BlogListLoader` computes `prev`/`next`, but sorted `BlogListView` ignores them, and `BlogSectionContinuous` loads subsequent pages without forwarding the active `sortby`. | [A-017 result](results/A-017-search-navigation-discovery.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-101 | A-017 | Medium | Converted | Main navigation fails closed when dynamic biography or collection nav data is unavailable. | A-017 found `MainNavLoader` depends on the first biography article and first collection; if dynamic navigation data is missing, the catch path returns no `MainNav` instead of stable route-root fallbacks. | [A-017 result](results/A-017-search-navigation-discovery.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-102 | A-017 | Medium | Converted | Visible breadcrumbs use mechanical URL segments while content-aware breadcrumbs exist only in JSON-LD. | A-017 found the rendered breadcrumb component maps URL segments directly and labels 24-character hex segments as `artworkId`, while detail pages already have content-aware breadcrumb structured data that is not reused in the visible UI. | [A-017 result](results/A-017-search-navigation-discovery.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-103 | A-018 | Medium | Converted | Collection section taxonomy needs a launch policy and runtime validation at public boundaries. | A-018 found collection schemas accept multiple section values that are hidden from admin create/update workflows, while public article/collection list and article-navigation section parameters pass raw or compile-time-only values into services without route-local runtime validation. | [A-018 result](results/A-018-translations-content-taxonomy.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [data/API workstream](../workstreams/data-models-and-api.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled 2026-05-19 |
| F-104 | A-018, A-020 | Low | Duplicate | Footer placeholder social links, stale copyright text, and commerce assurance copy need owner-approved cleanup. | A-018 found footer social anchors still use `href="#"` and the footer copyright is fixed at 2024. A-020 already tracks placeholder social links and commerce assurance/legal copy under compliance follow-ups, so cleanup should stay coordinated with F-078/R-018 rather than becoming an isolated copy change. | F-078, [A-018 result](results/A-018-translations-content-taxonomy.md), [A-020 result](results/A-020-privacy-consent-commerce-compliance.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md) | Reconciled 2026-05-19 |
