...
| F-124 | A-027, A-035 | High | Converted | `npm run build` still needs live external data access during static generation, with accidental hard-failure paths and intentional ISR/static evidence requirements. | A-027 found sandbox build failed on MongoDB SRV DNS and passed with external network access. A-035 mapped accidental hard failures on `/account*` and `/project/about`, plus intentional external data surfaces for `/biography`, `/collections`, and `/sitemap.xml`; `/prototype/home` also performed live reads during production build. T-283 removed the root-header navigation live-read path from this build-coupling set. | [A-027 result](results/A-027-verification-gate-snapshot.md), [A-035 result](results/A-035-build-external-dependency-map.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [T-278](../tasks/T-278-isolate-account-project-build-hard-failures.md), [T-279](../tasks/T-279-document-external-build-evidence-policy.md), [T-283](../tasks/T-283-make-root-header-nav-build-static-safe.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
...
| F-126 | A-027, A-033 | Medium | Converted | Repository-owned CI and smoke evidence do not cover the full local verification or release-smoke baseline. | A-027 found only the public-smoke workflow exists and it does not run install/env/Jest/lint/build/typecheck. A-033 confirmed public smoke is unauthenticated and scheduled/detail coverage depends on owner-provided repo variables; credential/admin smoke and Vercel log evidence remain manual and owner-blocked. | [A-027 result](results/A-027-verification-gate-snapshot.md), [A-033 result](results/A-033-deployment-monitoring-smoke.md), [testing workstream](../workstreams/testing-and-quality.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-274](../tasks/T-274-prepare-production-ops-owner-decision-packet.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
...
| F-142 | A-032 | Low | Converted | Legacy session/admin helper files remain unused by active route boundaries and should be reconciled before pruning. | T-290 classified all current `src/lib/session/*` helpers: `getUserIdFromSession.ts` and `requireAdminFrontendAccess.ts` are active; `createUserFromSession.ts`, `getUserFromSession.ts`, and `isAdmin.ts` are repo-local pruning candidates with no active source callers. The protected API guard inventory still bans direct helper use at protected API boundaries. | [A-032 result](results/A-032-auth-protected-boundaries.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [auth/admin workstream](../workstreams/auth-admin-and-permissions.md), [T-290](../tasks/T-290-scope-legacy-session-helper-pruning.md), [T-291](../tasks/T-291-prune-unused-legacy-session-helpers.md) | T-290 completed inventory and routed deletion to T-291 on 2026-05-25 |
