...
| F-126 | A-027, A-033 | Medium | Partially mitigated | Repository-owned CI and smoke evidence did not cover the full local verification or release-smoke baseline. | A-027 found only the public-smoke workflow existed and it did not run install/env/Jest/lint/build/typecheck. T-286 added repo-owned local verification scripts and T-288 added the non-secret Main CI workflow for typecheck, full Jest, build, lint, and event-aware whitespace checks. A-033 confirmed public smoke is unauthenticated and scheduled/detail coverage depends on owner-provided repo variables; credential/admin smoke and Vercel log evidence remain manual and owner-blocked. | [A-027 result](results/A-027-verification-gate-snapshot.md), [A-033 result](results/A-033-deployment-monitoring-smoke.md), [testing workstream](../workstreams/testing-and-quality.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-274](../tasks/T-274-prepare-production-ops-owner-decision-packet.md), [T-286](../tasks/T-286-own-local-verification-gate-scripts.md), [T-288](../tasks/T-288-add-main-ci-local-gate-workflow.md), [production risks](../risks/production-readiness.md) | T-288 completed 2026-05-25 |
...
| F-144 | A-033 | High | Partially mitigated | Incident authority, Vercel log/rollback ownership, credentialed smoke accounts, and public-smoke repository variables remain owner/platform blocked. | A-033 found the incident owner matrix and Vercel operator rows still blocked, complete smoke evidence cannot be produced without approved non-admin/admin smoke accounts and Vercel log access, and scheduled/detail public smoke needs non-secret owner-approved repo variables. On 2026-05-27 the owner created a local `VERCEL_TOKEN` for approved Vercel CLI/API deployment and targeted log inspection. Rollback, project settings, alias/domain changes, backup operator authority, credentialed smoke accounts, and public-smoke repository variables remain open. | [A-033 result](results/A-033-deployment-monitoring-smoke.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [testing workstream](../workstreams/testing-and-quality.md), [T-274](../tasks/T-274-prepare-production-ops-owner-decision-packet.md), [production risks](../risks/production-readiness.md) | Vercel log token capacity recorded 2026-05-27 |
