...
| F-116 | A-022 | Medium | Duplicate | Next.js instrumentation and web-vitals reporting remain absent, but this is already owned by the monitoring provider decision track. | A-022 found no `instrumentation.ts`, `useReportWebVitals`, monitoring SDK, OpenTelemetry, Sentry, or web-vitals package usage. F-080/R-019/ADR 0005 own the monitoring track; Sentry is now approved and implementation is routed to T-310. | F-080, [A-022 result](results/A-022-nextjs-feature-utilization.md), [production risks](../risks/production-readiness.md), [ADR 0005](../decisions/0005-monitoring-provider-decision.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-310](../tasks/T-310-implement-sentry-monitoring-baseline.md) | Updated after Sentry approval 2026-05-27 |
...
| F-143 | A-033 | High | Converted | Monitoring provider/no-provider launch posture remains blocked, leaving no provider SDK, `instrumentation.ts`, source-map/release tracking, dashboard, uptime check, or alert automation. | A-033 found no monitoring provider dependency or app `instrumentation.ts`; ADR 0005 originally kept provider work blocked until owner/platform decision. On 2026-05-27 the owner approved Sentry, so provider choice is unblocked and routed to T-310. Runtime Sentry implementation, source-map policy, alert routing, uptime checks, and dashboard/operator ownership remain open. | [A-033 result](results/A-033-deployment-monitoring-smoke.md), [ADR 0005](../decisions/0005-monitoring-provider-decision.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-274](../tasks/T-274-prepare-production-ops-owner-decision-packet.md), [T-310](../tasks/T-310-implement-sentry-monitoring-baseline.md), [production risks](../risks/production-readiness.md) | Sentry approved / T-310 prepared 2026-05-27 |
| F-144 | A-033 | High | Converted | Incident authority, Vercel log/rollback ownership, credentialed smoke accounts, and public-smoke repository variables remain owner/platform blocked. | A-033 found the incident owner matrix and Vercel operator rows still blocked, complete smoke evidence cannot be produced without approved non-admin/admin smoke accounts and Vercel log access, and scheduled/detail public smoke needs non-secret owner-approved repo variables. | [A-033 result](results/A-033-deployment-monitoring-smoke.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [testing workstream](../workstreams/testing-and-quality.md), [T-274](../tasks/T-274-prepare-production-ops-owner-decision-packet.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
