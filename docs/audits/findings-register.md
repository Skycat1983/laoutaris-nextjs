...
| F-112 | A-022 | High | Converted | The current client import graph has regressed and can pull server-only/model/mixed-barrel modules into a client component. | A-022 targeted tests failed because `src/components/modules/forms/user/SignUpForm.tsx` imports the broad `@/lib/constants` barrel, which reaches `src/lib/constants/index.ts`, model/transforms barrels, and mixed component barrels. | [A-022 result](results/A-022-nextjs-feature-utilization.md), [production risks](../risks/production-readiness.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [T-230](../tasks/T-230-fix-client-import-boundary-regression.md) | Reconciled 2026-05-23 |
| F-113 | A-022 | High | Converted | Middleware still matches most public paths before returning early, leaving avoidable request-time work and future proxy migration risk. | `src/middleware.ts` matches `"/((?!api/auth|_next/static|_next/image|favicon.ico).*)"`; public routes avoid `getToken()` after T-102 but middleware still executes for most public pages and public APIs. Build reported middleware size at 48 kB. | [A-022 result](results/A-022-nextjs-feature-utilization.md), [production risks](../risks/production-readiness.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [T-231](../tasks/T-231-narrow-protected-middleware-matcher.md) | Reconciled 2026-05-23 |
