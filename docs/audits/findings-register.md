...
| F-095 | A-011 | Medium | Partially mitigated | Admin archive maintenance relies on manual ObjectId copy/paste and shallow unpaginated read lists. | T-152 added direct read-list Update/Delete actions for articles, artwork, blogs, and collections. Those actions switch to the existing update/delete workflows and seed `DocumentReader` with the selected ObjectId, leaving manual ObjectId lookup as an escape hatch. Shallow first-page read lists and richer paginated/searchable admin archive tables remain separate. | [A-011 result](results/A-011-admin-content-operations.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [frontend workstream](../workstreams/frontend-routes-and-components.md), [T-152](../tasks/T-152-improve-admin-archive-entry-points.md) | T-152 completed 2026-05-19 |
