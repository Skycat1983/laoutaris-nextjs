...
| F-123 | A-027, A-034 | High | Converted | Full Jest is not currently a usable release gate under the pinned runtime. | A-027 found `npm test` failed with 12 failed suites and 22 failed tests; A-034 reran under Node `22.14.0` and narrowed the current red baseline to 7 failed suites and 10 failed tests: deterministic product image/semantic-style assertion drift, admin/form full-run timeouts, and one sandbox socket artifact. | [A-027 result](results/A-027-verification-gate-snapshot.md), [A-034 result](results/A-034-current-jest-failure-triage.md), [testing workstream](../workstreams/testing-and-quality.md), [T-276](../tasks/T-276-fix-deterministic-jest-assertion-drift.md), [T-277](../tasks/T-277-stabilize-admin-jest-full-run-timeouts.md), [T-280](../tasks/T-280-handle-public-smoke-socket-sandbox-path.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
| F-124 | A-027, A-035 | High | Converted | `npm run build` still needs live external data access during static generation, with accidental hard-failure paths and intentional ISR/static evidence requirements. | A-027 found sandbox build failed on MongoDB SRV DNS and passed with external network access. A-035 mapped accidental hard failures on `/account*` and `/project/about`, plus intentional external data surfaces for `/biography`, `/collections`, and `/sitemap.xml`; root header navigation and `/prototype/home` also perform live reads during production build. | [A-027 result](results/A-027-verification-gate-snapshot.md), [A-035 result](results/A-035-build-external-dependency-map.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [T-278](../tasks/T-278-isolate-account-project-build-hard-failures.md), [T-279](../tasks/T-279-document-external-build-evidence-policy.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
| F-125 | A-027 | Medium | Partially mitigated | Explicit TypeScript checking is useful but not yet an owned gate. | A-027 found `npx tsc --noEmit --pretty false --skipLibCheck` red on four test-file diagnostics and absent from scripts/CI. T-268 fixed the A-027 diagnostics and one type-only public-search narrowing issue so the command passed, but T-273 later introduced a narrow admin frontend guard test mock typing diagnostic now routed to T-275. | [A-027 result](results/A-027-verification-gate-snapshot.md), [testing workstream](../workstreams/testing-and-quality.md), [T-268](../tasks/T-268-fix-explicit-typecheck-test-errors.md), [T-275](../tasks/T-275-restore-explicit-typecheck-after-admin-guard.md) | T-268 completed 2026-05-25; T-275 planned |
...
| F-141 | A-032 | Low | Converted | OAuth role/session behavior lacks a provider-specific propagation test. | A-032 found adapter-created OAuth users default to `role: "user"` and generic callbacks copy role, but no provider-specific OAuth role/session test exists. | [A-032 result](results/A-032-auth-protected-boundaries.md), [auth/admin workstream](../workstreams/auth-admin-and-permissions.md), [testing workstream](../workstreams/testing-and-quality.md) | Reconciled by T-267 on 2026-05-25 |
| F-142 | A-032 | Low | Converted | Legacy session/admin helper files remain unused by active route boundaries and should be reconciled before pruning. | A-032 found stale helper files in `src/lib/session/`, while the protected API guard inventory bans direct helper use at protected API boundaries. Pruning should stay in the source-pruning/code-health track. | [A-032 result](results/A-032-auth-protected-boundaries.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [auth/admin workstream](../workstreams/auth-admin-and-permissions.md) | Reconciled by T-267 on 2026-05-25 |
...
| F-146 | A-035 | Medium | Converted | Root header navigation and `/prototype/home` still add live MongoDB/Shopify reads to production build beyond the immediate account/project hard-failure task. | A-035 found the global header navigation performs MongoDB reads during prerendering and `/prototype/home` prerenders through live archive/shop data with degraded fallbacks. These are not part of T-278/T-279 and should be separately scoped before broad build-isolation work. | [A-035 result](results/A-035-build-external-dependency-map.md), [architecture workstream](../workstreams/architecture-refactor-and-code-health.md), [deployment workstream](../workstreams/deployment-security-and-observability.md), [frontend workstream](../workstreams/frontend-routes-and-components.md) | Reconciled by T-267 on 2026-05-25 |
