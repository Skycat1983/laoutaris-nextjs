...
2026-05-18: Prepared T-125 for F-081/R-019 as the lower-level service/client
logging policy and inventory task. It should document the non-route direct
`console.error()`/`console.warn()` surfaces and define migration categories
before broad service, loader, action, client, utility, or provider-client
logging changes are assigned.
