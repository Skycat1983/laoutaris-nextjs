...
| F-131 | A-028 | Medium | Converted | Product-detail frame/mat/gallery controls are preview-only and need owner review before they affect purchase, enquiry, variant, price, or persistence behavior. | A-028 confirmed T-261 sale-gallery controls keep state local, architecture documents the preview-only boundary, and enquiry carries only product-handle context. The Shopify workstream routes the next step to owner-review/visual QA, not more commerce behavior. | [A-028 result](results/A-028-public-shopify-hotspots.md), [Shopify workstream](../workstreams/shopify-commerce.md), [Shopify commerce architecture](../architecture/shopify-commerce.md), [T-261](../tasks/T-261-build-shop-product-sale-gallery-mockup.md) | Reconciled by T-267 on 2026-05-25 |
...
| F-137 | A-031 | Medium | Converted | Blog and collection image controls still rely on raw URL paste with submit-time allowlist validation and no admin media picker. | A-031 found blog and collection image URL fields preview HTTP(S) strings before submit, but approved-host policy feedback happens only when create/update requests are submitted. This remains a lower-priority admin media workflow after artwork replacement. | [A-031 result](results/A-031-admin-content-controls.md), [content/admin workstream](../workstreams/content-assets-and-admin-ops.md), [production risks](../risks/production-readiness.md) | Reconciled by T-267 on 2026-05-25 |
