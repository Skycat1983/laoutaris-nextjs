import ButtonDivider from "../../src/components/elements/misc/ButtonDivider";
import HorizontalDivider from "../../src/components/elements/misc/HorizontalDivider";
import SectionHeading from "../../src/components/elements/typography/SectionHeading";
import { ScrollArea, ScrollBar } from "../../src/components/shadcn/scroll-area";
import BiographyCard from "../../src/components/modules/cards/BiographyCard";
import { BiographyCardData } from "../../src/components/loaders/sectionLoaders/BiographySectionLoader";
