export const FAMILY_FAVOURITES_SLIDE = {
  _id: { $oid: "65a4f7c9e4b0a3d1f0e12345" },
  title: "Family Favourites",
  subtitle: "A curated collection",
  summary: "A beloved piece chosen by each of his grandchildren",
...
export const COMING_SOON_SLIDE = {
  _id: { $oid: "65a4f7c9e4b0a3d1f0e12345" },
  title: "Exploring Abstract Art",
  subtitle: "A Journey from figurative beginnings",
  summary: "A collection of works showcasing the evolution of Granddad's art.",
  text: "Abstract art has transformed the way we perceive creativity. From Kandinsky to Pollock, artists have pushed the boundaries of form and meaning.",
  imageUrl:
...
const slideDataColoursOrange = {
  ...
  text: "Abstract art has transformed the way we perceive creativity. From Kandinsky to Pollock, artists have pushed the boundaries of form and meaning.",
  imageUrl:
    "https://res.cloudinary.com/dzncmfirr/image/upload/v1706776924/studio-thumbnails/JRL_studio1_013_ubopul.jpg",
  // "https://res.cloudinary.com/dzncmfirr/image/upload/c_crop,h_1800,w_3000/v1739636066/artwork/lxkuzke740r4flfk8rky.jpg",
  // "https://res.cloudinary.com/dzncmfirr/image/upload/v1740842922/artwork/l6z2fgc2h2cabvadzs5o.jpg",
  // "https://res.cloudinary.com/dzncmfirr/image/upload/v1741018193/artwork/hc9zoxn6xfesnr6lgz9i.jpg",
