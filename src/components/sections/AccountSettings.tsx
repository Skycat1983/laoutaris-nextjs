...
export const AccountSettingsV3 = async (props: OwnUserFrontend) => {
  const { email, username, favouritedCount, watchlistCount, commentCount } =
    props;
          ...
          <section>
            ...
            <dl className="divide-y divide-gray-100">
              ...
              <div className="py-4 flex justify-between">
                ...
                <dd className="text-sm text-gray-900">{favouritedCount}</dd>
              </div>
              <div className="py-4 flex justify-between">
                <dt className="text-sm text-gray-500">Watchlist Items</dt>
                <dd className="text-sm text-gray-900">{watchlistCount}</dd>
              </div>
              {/* <div className="py-4 flex justify-between">
...
// export const AccountSettingsV1 = async (props: OwnUserFrontend) => {
...
//   );
// };
// export const AccountSettingsV2 = async (props: OwnUserFrontend) => {
//   const { email, username, favourites, watchlist, createdAt } = props;
