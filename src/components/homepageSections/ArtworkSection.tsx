...
const ArtworkSection = () => {
  ...
  return (
    <>
      ...
      <section className="p-4 grid grid-cols-1 grid-rows-6 sm:grid-cols-2 sm:grid-rows-3 lg:grid-cols-6 lg:grid-rows-1 w-full py-8 gap-5 ">
