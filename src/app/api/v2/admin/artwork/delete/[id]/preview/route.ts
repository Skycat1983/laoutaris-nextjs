...
export async function GET(
  ...
  return adminDeletePreviewResponse({
    request,
    route: "/api/v2/admin/artwork/delete/[id]/preview",
    id,
    adminUserId: admin.userId,
    notFoundMessage: "Artwork not found",
    failureMessage: "Failed to preview artwork deletion",
    operation: "admin.artwork.delete",
    errorLabel: "admin_artwork_delete_preview_failed",
    getPreview: getArtworkDeletePreview,
  });
}
