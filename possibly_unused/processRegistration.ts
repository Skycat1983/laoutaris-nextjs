...
import { validateRegistrationData } from "../src/lib/server/user/validation/validateRegistrationData";
import { registerUser } from "../src/lib/server/user/data-fetching/registerUser";
